...
{
    public class KeyVaultKeyVersion : KeyVaultTreeItem
    {
        ...
        {
            get { return KeyItem.Attributes; }
            set { KeyItem.Attributes = value; }
        }

        public Dictionary<string, string> Tags => KeyItem.Tags;

        public KeyVaultKeyVersion(KeyVaultClient client, KeyItem keyItem)
        {
            Client = client;
            KeyItem = keyItem;
        }
